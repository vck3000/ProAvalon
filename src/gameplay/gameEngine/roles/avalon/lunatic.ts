...
class Lunatic implements IRole {
  room: Game;

  static role = Role.Lunatic;
  role = Role.Lunatic;

  alliance = Alliance.Spy;

  description =
    'The Lunatic is on the side of Evil, and they must Fail every Quest that they are on';
  orderPriorityInOptions = 74;
  ...
  // Lunatic sees all spies except Oberon (same as Spy)
  see(): See {
