...
module.exports = function(schema, options) {
  ...
  schema.statics.authenticate = function() {
    return (username, password, cb) => {
      ...
      this.findByUsername(new RegExp("^" + escapeRegExp(username) + "$", "i"), true, (err, user) => {
  ...
  schema.statics.register = function(user, password, cb) {
    ...
    this.findByUsername(new RegExp("^" + escapeRegExp(user.get(options.usernameField)) + "$", "i"), (err, existingUser) => {
      if (err) { return cb(err); }
