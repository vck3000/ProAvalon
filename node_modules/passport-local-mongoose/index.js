...
module.exports = function (schema, options) {
  ...
  schema.statics.authenticate = function () {
    ...
    return function (username, password, cb) {
      ...
      self.findByUsername(new RegExp("^" + username + "$", "i"), true, function (err, user) {
  ...
  schema.statics.register = function (user, password, cb) {
    ...
    self.findByUsername(new RegExp("^" + user.get(options.usernameField) + "$", "i"), function (err, existingUser) {
      if (err) { return cb(err); }
