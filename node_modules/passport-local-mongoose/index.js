...
module.exports = function (schema, options) {
  ...
  schema.statics.authenticate = function () {
    ...
    return function (username, password, cb) {
      ...
      self.findByUsername(new RegExp("^" + escapeRegExp(username) + "$", "i"), true, function (err, user) {

        //update the username with the new caps
        //VICTOR CHANGES
        // console.log(user);
        if (user) {
  ...
  schema.statics.register = function (user, password, cb) {
    ...
    self.findByUsername(new RegExp("^" + escapeRegExp(user.get(options.usernameField)) + "$", "i"), function (err, existingUser) {
      if (err) { return cb(err); }
