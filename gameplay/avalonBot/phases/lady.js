...
class Lady {
    ...
    gameMove(socket, buttonPressed, selectedPlayers) {
        ...
        const ladyHistory = this.thisRoom.specialCards[this.card.toLowerCase()].ladyHistory;
    ...
    getStatusMessage(indexOfPlayer) {
        ...
        const usernameOfCardHolder = this.thisRoom.playerUsernamesInGame[indexOfCardHolder];
