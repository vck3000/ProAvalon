...
$root.ChatRequest = (function() {
  ...
  ChatRequest.fromObject = function fromObject(object) {
    if (object instanceof $root.ChatRequest) return object;
...
$root.ChatResponse = (function() {
  ...
  ChatResponse.decode = function decode(reader, length) {
    ...
    if (!message.hasOwnProperty('username'))
      throw $util.ProtocolError("missing required 'username'", {
        instance: message,
      });
  ...
  ChatResponse.fromObject = function fromObject(object) {
    if (object instanceof $root.ChatResponse) return object;
    ...
    if (message.type != null && message.hasOwnProperty('type'))
      object.type =
        options.enums === String
          ? $root.ChatResponse.ChatResponseType[message.type]
          : message.type;
    return object;
  };
...
$root.ChatResponses = (function() {
  ...
  ChatResponses.encode = function encode(message, writer) {
    ...
    if (message.chatResponses != null && message.chatResponses.length)
      for (var i = 0; i < message.chatResponses.length; ++i)
        $root.ChatResponse.encode(
          message.chatResponses[i],
  ...
  ChatResponses.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.ChatResponses();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          ...
          message.chatResponses.push(
            $root.ChatResponse.decode(reader, reader.uint32()),
          );
          break;
        default:
          reader.skipType(tag & 7);
  ...
  ChatResponses.verify = function verify(message) {
    if (typeof message !== 'object' || message === null)
      return 'object expected';
    if (
      message.chatResponses != null &&
      message.hasOwnProperty('chatResponses')
    ) {
      ...
      for (var i = 0; i < message.chatResponses.length; ++i) {
        ...
        if (error) return 'chatResponses.' + error;
      }
    }
    return null;
  };
  ...
  ChatResponses.fromObject = function fromObject(object) {
    if (object instanceof $root.ChatResponses) return object;
    ...
    if (object.chatResponses) {
      ...
      for (var i = 0; i < object.chatResponses.length; ++i) {
        ...
        message.chatResponses[i] = $root.ChatResponse.fromObject(
          object.chatResponses[i],
        );
      }
    }
    return message;
  ...
  ChatResponses.toObject = function toObject(message, options) {
    if (!options) options = {};
    var object = {};
    if (options.arrays || options.defaults) object.chatResponses = [];
    if (message.chatResponses && message.chatResponses.length) {
      object.chatResponses = [];
      for (var j = 0; j < message.chatResponses.length; ++j)
        object.chatResponses[j] = $root.ChatResponse.toObject(
          message.chatResponses[j],
          options,
        );
    }
    return object;
