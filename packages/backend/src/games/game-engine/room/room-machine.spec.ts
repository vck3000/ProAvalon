...
describe('RoomMachine [Base]', () => {
  ...
  //   xit('should be able to let a user leave while sat down', () => {
  ...
  //   });
  //
  //   xit('should only start game if there are at least 5 players sitting down', () => {
  //     const gen = mockPlayerGen();
  //
  //     // Only add 4 players
  //     for (let i = 0; i < 4; i += 1) {
  ...
  //     expect(service.state.value).toEqual('waxiting');
  //
  //     // Join the 5th player
  //     const player = gen.next().value;
  //     service.send('PLAYER_JOIN', { player });
  ...
  //   });
  //
  //   xit('should not allow duplicate users', () => {
  //     const gen = mockPlayerGen();
  //     const player = gen.next().value;
  //
  //     service.send('PLAYER_JOIN', { player });
...
//   });
//
//   xit('should be able to transition between pick and vote', () => {
...
//   });
//
//   xit('should only pick if requester is leader', () => {
//     expect(service.state.value).toMatchObject({ game: { standard: 'pick' } });
//
//     const { leader } = service.state.context.game;
//
...
//   });
//
//   xit('should not be able to transition standard states in special state', () => {
//     const { leader } = service.state.context.game;
//     // Starting state
//     expect(service.state.value).toEqual({
//       game: { standard: 'pick', special: 'idle' },
...
//   xit.only('should go into a special state correctly', () => {
//     expect(service.state.value).toMatchObject({ game: { standard: 'pick' } });
//
//     // Leader make a pick
//     const { leader } = service.state.context.game;
