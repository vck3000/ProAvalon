...
var userOptions = {
  ...
  optionDisplayHeightOfAvatarContainer: {
    ...
    onLoad() {
      // get cookie data
      let containerHeight = docCookies.getItem(
        'optionDisplayHeightOfAvatarContainer'
      );
      ...
      // set the value in the users display
      $('#option_display_avatar_container_height_text')[0].value =
        containerHeight;
    },
    initialiseEventListener() {
      ...
      $('#div1Resize').resize(() => {
        ...
        $('#div1Resize').resizable(
          'option',
          'minHeight',
          parseInt($(window).height() * 0.25, 10)
        );
        $('#div1Resize').resizable(
          'option',
          'maxHeight',
          parseInt($(window).height() * 0.66, 10)
        );
      });
      ...
      $('#option_display_avatar_container_height_text').on('change', () => {
        let containerHeight = $(
          '#option_display_avatar_container_height_text'
        )[0].value;
    ...
    avatarContainerHeightAdjust() {
      $('#div2Resize').height(
        $('#div2Resize').parent().height() - $('#div1Resize').height()
      );
      ...
      // get cookie data
      const containerHeight = docCookies.getItem(
        'optionDisplayHeightOfAvatarContainer'
      );
  ...
  optionDisplayMaxAvatarHeight: {
    ...
    onLoad() {
      // get cookie data
      const maxAvatarHeight = docCookies.getItem(
        'optionDisplayMaxAvatarHeight'
      );
  ...
  optionDisplayUseSmallIconsCrownShield: {
    ...
    initialiseEventListener() {
      $('#optionDisplayUseSmallIconsCrownShield')[0].addEventListener(
        'click',
        () => {
          // when they press it...
          const newCheck = $('#optionDisplayUseSmallIconsCrownShield')[0]
            .checked;
          // save their option in cookie
          docCookies.setItem(
            'optionDisplayUseSmallIconsCrownShield',
  ...
  optionNotificationsSoundEnable: {
    ...
    initialiseEventListener() {
      $('#option_notifications_sound_enable')[0].addEventListener(
        'click',
        () => {
  ...
  optionNotificationsSoundEnableInGame: {
    ...
    onLoad() {
      let checked;
      const savedSetting = docCookies.getItem(
        'optionNotificationsSoundEnableInGame'
      );
      if (savedSetting === 'true') {
        checked = true;
    ...
    initialiseEventListener() {
      $('#option_notifications_sound_enable_in_game')[0].addEventListener(
        'click',
        () => {
          const { checked } = $(
            '#option_notifications_sound_enable_in_game'
          )[0];
          // save their option in cookie
          docCookies.setItem(
            'optionNotificationsSoundEnableInGame',
  ...
  optionNotificationsSoundVolume: {
    ...
    onLoad() {
      ...
      const volumeSlider = document.getElementById(
        'option_notifications_sound_volume'
      );
    ...
    initialiseEventListener() {
      $('#option_notifications_sound_volume')[0].addEventListener(
        'click',
        () => {
  ...
  optionNotificationsSoundPlayersJoiningRoom: {
    ...
    onLoad() {
      ...
      $('#option_notifications_sound_players_joining_room')[0].checked =
        checked;
    },
    initialiseEventListener() {
      $('#option_notifications_sound_players_joining_room')[0].addEventListener(
        'click',
        () => {
          const { checked } = $(
            '#option_notifications_sound_players_joining_room'
          )[0];
          // save their option in cookie
          docCookies.setItem(
            'optionNotificationsSoundPlayersJoiningRoom',
  ...
  optionNotificationsSoundPlayersJoiningGame: {
    ...
    onLoad() {
      ...
      $('#option_notifications_sound_players_joining_game')[0].checked =
        checked;
    },
    initialiseEventListener() {
      $('#option_notifications_sound_players_joining_game')[0].addEventListener(
        'click',
        () => {
          const { checked } = $(
            '#option_notifications_sound_players_joining_game'
          )[0];
          // save their option in cookie
          docCookies.setItem(
            'optionNotificationsSoundPlayersJoiningGame',
  ...
  optionNotificationsSoundGameStarting: {
    ...
    initialiseEventListener() {
      $('#option_notifications_sound_game_starting')[0].addEventListener(
        'click',
        () => {
  ...
  optionNotificationsSoundYourTurn: {
    ...
    initialiseEventListener() {
      $('#option_notifications_sound_your_turn')[0].addEventListener(
        'click',
        () => {
  ...
  optionNotificationsSoundGameEnding: {
    ...
    initialiseEventListener() {
      $('#option_notifications_sound_game_ending')[0].addEventListener(
        'click',
        () => {
  ...
  optionNotificationsSoundPunch: {
    ...
    initialiseEventListener() {
      $('#option_notifications_sound_punch')[0].addEventListener(
        'click',
        () => {
  ...
  optionNotificationsSoundBuzzSlapTimeout: {
    ...
    onLoad() {
      // get cookie data
      const seconds = docCookies.getItem(
        'optionNotificationsSoundBuzzSlapTimeout'
      );
    ...
    initialiseEventListener() {
      $('#option_notifications_buzz_slap_timeout')[0].addEventListener(
        'click',
        () => {
          const valueToStore = $('#option_notifications_buzz_slap_timeout')[0]
            .value;
          // save their option in cookie
          docCookies.setItem(
            'optionNotificationsSoundBuzzSlapTimeout',
  ...
  optionNotificationsDesktopEnable: {
    ...
    initialiseEventListener() {
      $('#option_notifications_desktop_enable')[0].addEventListener(
        'click',
        () => {
  ...
  optionNotificationsDesktopPlayersJoiningRoom: {
    ...
    initialiseEventListener() {
      $(
        '#option_notifications_desktop_players_joining_room'
  ...
  optionNotificationsDesktopPlayersJoiningGame: {
    ...
    initialiseEventListener() {
      $(
        '#option_notifications_desktop_players_joining_game'
      )[0].addEventListener('click', () => {
        const { checked } = $(
          '#option_notifications_desktop_players_joining_game'
        )[0];
  ...
  optionNotificationsDesktopGameStarting: {
    ...
    initialiseEventListener() {
      $('#option_notifications_desktop_game_starting')[0].addEventListener(
        'click',
        () => {
          const { checked } = $(
            '#option_notifications_desktop_game_starting'
          )[0];
          // save their option in cookie
          docCookies.setItem(
            'optionNotificationsDesktopGameStarting',
  ...
  optionNotificationsDesktopYourTurn: {
    ...
    initialiseEventListener() {
      $('#option_notifications_desktop_your_turn')[0].addEventListener(
        'click',
        () => {
  ...
  optionNotificationsDesktopGameEnding: {
    ...
    initialiseEventListener() {
      $('#option_notifications_desktop_game_ending')[0].addEventListener(
        'click',
        () => {
  ...
  optionNotificationsDesktopBuzz: {
    ...
    initialiseEventListener() {
      $('#option_notifications_desktop_buzz')[0].addEventListener(
        'click',
        () => {
